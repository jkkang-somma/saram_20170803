...
// 근태자료관리 조회 
CommuteDao.prototype.selectCommute =  function (data, id, dept) {
    if(data.dept == "전체" && id === '%'){
...
CommuteDao.prototype.insertCommute = function(data){
    return {
        ...
        data : [
                ...
                data.early_time, data.not_pay_over_time, data.normal, data.normal_change, data.except, data.is_suwon ]
    };
};
