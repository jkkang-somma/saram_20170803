...
(`id`, `name`, `dept_code`, `name_commute`, `join_company`, `privilege`, `admin`, `email`, `position`, `phone`) 
VALUES 
  ('001201','이국원','0000','이국원','2000-12-15',3,0,'leekw@yescnc.co.kr','부사장','010-4543-9027'),
  ('0120801','석정훈','7100','석정훈','2012-08-07',3,0,'seokjh@yescnc.co.kr','책임','010-6345-9124'),
  ('0130101','조영재','5100','조영재','2013-01-01',3,0,'young77.cho@yescnc.co.kr','책임','010-9259-2577'),
  ('0140201','김정숙','5100','김정숙','2014-02-10',3,0,'sookida@yescnc.co.kr','책임','010-3300-3455'),
  ('0150101','손애호','7300','손애호','2015-01-01',3,0,'ahson@yescnc.co.kr','책임','010-3252-2432'),
  ('0150102','김종민','7100','김종민','2015-01-05',3,0,'jmpp321@yescnc.co.kr','선임','010-9068-8290'),
  ('030301','이혜영','1000','이혜영','2003-03-01',3,0,'leehy@yescnc.co.kr','대리','010-4754-7533'),
  ('050601','김특훈','0000','김특훈','2005-06-01',3,0,'thkim@yescnc.co.kr','대표이사','010-9530-2910'),
  ('050801','최정민','7100','최정민','2005-08-08',3,0,'choijm@yescnc.co.kr','책임','010-6367-4684'),
  ('060601','윤정관','7100','윤정관','2006-06-01',3,0,'jkyoon96@yescnc.co.kr','수석','010-3650-9339'),
  ('070801','류원혁','8100','류원혁','2007-08-01',3,0,'ryu008@yescnc.co.kr','책임','010-9626-6606'),
  ('070901','김태중','7300','김태중','2007-09-01',3,0,'hhs2tjk@yescnc.co.kr','수석','010-2679-4562'),
  ('071001','권기정','8100','권기정','2007-10-01',3,0,'gjkwon@yescnc.co.kr','수석','010-4313-7859'),
  ('071003','이조명','7300','이조명','2007-10-22',3,0,'ljmnonoc@yescnc.co.kr','책임','010-8249-1562'),
  ('071101','김성록','7300','김성록','2007-11-01',3,0,'seongrok@yescnc.co.kr','수석','010-3000-2991'),
  ('071102','박수종','7200','박수종','2007-11-02',3,0,'soojong@yescnc.co.kr','수석','010-9911-6927'),
  ('071103','고주필','7100','고주필','2007-11-03',3,0,'jfko00@yescnc.co.kr','책임','010-8881-0513'),
  ('071201','위성두','7100','위성두','2007-12-01',3,0,'lodric@yescnc.co.kr','책임','010-9985-4266'),
  ('080802','최치운','7100','최치운','2008-08-01',3,0,'cwchoi@yescnc.co.kr','책임','010-6637-1773'),
  ('080902','주용훈','7300','주용훈','2008-09-18',3,0,'zoo@yescnc.co.kr','책임','010-4223-0357'),
  ('080903','박준홍','7100','박준홍','2008-09-03',3,0,'parkjh@yescnc.co.kr','책임','010-3738-0462'),
  ('090401','고현진','7100','고현진','2009-04-01',3,0,'moggnik@yescnc.co.kr','책임','010-2664-5598'),
  ('090503','김태수','7200','김태수','2009-05-03',3,0,'tskim@yescnc.co.kr','책임','010-4658-7332'),
  ('090505','유희관','7300','유희관','2009-05-05',3,0,'koryokwan@yescnc.co.kr','책임','010-4742-8343'),
  ('090703','명성태','7100','명성태','2009-07-01',3,0,'ryoko@yescnc.co.kr','책임','010-4216-1171'),
  ('100102','김대원','5100','김대원','2010-01-02',3,0,'kimdaewon007@yescnc.co.kr','책임','010-6338-5678'),
  ('100103','이규훈','5100','이규훈','2010-01-03',3,0,'starmerit@yescnc.co.kr','책임','010-8896-7799'),
  ('100105','김연홍','7300','김연홍','2010-01-05',3,0,'heartofkim@yescnc.co.kr','책임','010-7744-2157'),
  ('100107','윤종호','5100','윤종호','2010-01-22',3,0,'ddangbee@yescnc.co.kr','책임','010-8840-8475'),
  ('100110','홍성우','5100','홍성우','2010-01-10',3,0,'hswsm73@yescnc.co.kr','책임','010-3259-8182'),
  ('100401','김근주','7300','김근주','2010-04-01',3,0,'keun_ju.kim@yescnc.co.kr','책임','010-7148-1027'),
  ('100402','이석준','7300','이석준','2010-04-02',3,0,'msmesm.lee@yescnc.co.kr','책임','010-5047-5291'),
  ('100403','설재훈','5100','설재훈','2010-04-05',3,0,'jaehun.seol@yescnc.co.kr','책임','010-2002-4664'),
  ('100404','정상훈','5100','정상훈','2010-04-04',3,0,'sh.jeong@yescnc.co.kr','책임','010-8250-1924'),
  ('100406','이상민','5100','이상민','2010-04-06',3,0,'interact14.lee@yescnc.co.kr','책임','010-3647-2147'),
  ('100501','강정규','7100','강정규','2010-06-01',3,0,'jkkang@yescnc.co.kr','책임','010-9059-3128'),
  ('100701','이진수','5100','이진수','2010-07-01',3,0,'panja79.lee@yescnc.co.kr','책임','010-4157-0456'),
  ('100801','박상철','5100','박상철','2010-08-01',3,0,'sc78.park@yescnc.co.kr','책임','010-3454-9483'),
  ('110103','정진범','5100','정진범','2011-02-01',3,0,'gil.jeong@yescnc.co.kr','선임','010-2872-9229'),
  ('110201','조응래','5100','조응래','2011-03-01',3,0,'ercho@yescnc.co.kr','수석','010-9917-0504'),
  ('110202','김남수','5100','김남수','2011-02-01',3,0,'ns0810.kim@yescnc.co.kr','책임','010-9428-4211'),
  ('110209','김성식','1000','김성식','2011-02-14',3,0,'sskim@yescnc.co.kr','부장','010-7102-5301'),
  ('110302','김기광','5100','김기광','2011-03-01',3,0,'Vincent.kim@yescnc.co.kr','책임','010-7132-7319'),
  ('110303','윤현승','5100','윤현승','2011-03-01',3,0,'netcom74.yoon@yescnc.co.kr','책임','010-9122-1606'),
  ('110602','김라경','7100','김라경','2011-06-13',3,0,'krg1314@yescnc.co.kr','선임','010-8460-1314'),
  ('110701','임성식','5100','임성식','2011-07-01',3,0,'sungcik.lim@yescnc.co.kr','책임','010-9555-4789'),
  ('110802','김유종','5200','김유종','2011-08-01',3,0,'yuzzong.kim@yescnc.co.kr','책임','010-3127-3035'),
  ('110804','최홍율','5100','최홍율','2011-08-16',3,0,'hongyul.choi@yescnc.co.kr','선임','010-4690-5607'),
  ('110901','정현우','5100','정현우','2011-09-06',3,0,'sangchang.jeong@yescnc.co.kr','책임','010-7409-2347'),
  ('111003','유성권','5100','유성권','2011-10-20',3,0,'sungkwon.yu@yescnc.co.kr','책임','010-7156-9907'),
  ('111101','김대범','8100','김대범','2011-11-01',3,0,'dbkim@yescnc.co.kr','연구원','010-4577-3947'),
  ('111102','남지성','8100','남지성','2011-11-01',3,0,'jsnam@yescnc.co.kr','연구원','010-9160-2100'),
  ('111201','김영빈','5200','김영빈','2011-12-19',3,0,'ybion@yescnc.co.kr','책임','010-6207-6347'),
  ('120102','김도영','5200','김도영','2012-01-01',3,0,'dykim092@yescnc.co.kr','수석','010-3250-7510'),
  ('120103','이창우','7300','이창우','2012-01-01',3,0,'cwlee@yescnc.co.kr','수석','010-5917-9527'),
  ('120301','하영진','5100','하영진','2012-03-01',3,0,'yj82.ha@yescnc.co.kr','책임','010-9886-6857'),
  ('120302','윤정민','7300','윤정민','2012-03-07',3,0,'jmsr.yoon@yescnc.co.kr','책임','010-6650-0529'),
  ('120401','윤장식','7300','윤장식','2012-04-16',3,0,'jsyun@yescnc.co.kr','책임','010-8567-8511'),
  ('120501','이종성','8100','이종성','2012-05-02',3,0,'jslee@yescnc.co.kr','책임','010-4255-7316'),
  ('120601','김태형','5100','김태형','2012-06-11',3,0,'Kimth727@yescnc.co.kr','연구원','010-6318-0775'),
  ('120701','김지훈','7300','김지훈','2012-07-02',3,0,'cygnus74@yescnc.co.kr','책임','010-3742-5635'),
  ('120801','윤호중','5100','윤호중','2012-08-01',3,0,'hjyun@yescnc.co.kr','책임','010-9222-4317'),
  ('120802','정희재','5200','정희재','2012-08-13',3,0,'hjJeong@yescnc.co.kr','책임','010-9278-2992'),
  ('121001','고승열','7300','고승열','2012-10-04',3,0,'syko@yescnc.co.kr','선임','010-4705-5735'),
  ('121102','백성준','7300','백성준','2012-11-12',3,0,'pack0331@yescnc.co.kr','수석','010-9530-4725'),
  ('130401','양명석','7300','양명석','2013-04-22',3,0,'msyang@yescnc.co.kr','선임','010-2259-2345'),
  ('130702','김은영','1000','김은영','2013-07-15',3,0,'eykim@yescnc.co.kr','사원','010-8383-5245'),
  ('130801','윤지민','8100','윤지민','2013-08-05',3,0,'cir213@yescnc.co.kr','연구원','010-2592-2595'),
  ('130901','이유진','7100','이유진','2013-09-02',3,0,'yjin719@yescnc.co.kr','연구원','010-7700-2143'),
  ('130902','류제욱','7100','류제욱','2013-09-09',3,0,'enlune@yescnc.co.kr','연구원','010-5297-2558'),
  ('130903','김영연','5200','김영연','2013-09-09',3,0,'youngdolli@yescnc.co.kr','책임','010-9522-1465'),
  ('130904','이진철','7300','이진철','2013-09-09',3,0,'ljc8189@yescnc.co.kr','책임','010-8759-8189'),
  ('131201','안정길','7100','안정길','2013-12-02',3,0,'carran@yescnc.co.kr','연구원','010-4604-5823'),
  ('140101','김원중','5100','김원중','2014-01-02',3,0,'wjkim03@yescnc.co.kr','책임','010-2334-6436'),
  ('140102','장준용','5100','장준용','2014-01-02',3,0,'jyjang@yescnc.co.kr','책임','010-6260-7685'),
  ('140103','이동주','5100','이동주','2014-01-02',3,0,'dongjulee@yescnc.co.kr','책임','010-8642-8262'),
  ('140104','오선중','5100','오선중','2014-01-02',3,0,'os2548oh@yescnc.co.kr','연구원','010-7771-4986'),
  ('140601','이기환','7100','이기환','2014-06-01',3,0,'lgh816@yescnc.co.kr','연구원','010-6476-6647'),
  ('140602','이정구','7100','이정구','2014-06-10',3,0,'ljg0717@yescnc.co.kr','선임','010-5475-8459'),
  ('140603','이지현','7100','이지현','2014-06-18',3,0,'jhlee@yescnc.co.kr','책임','010-4214-5453'),
  ('140604','장병국','5200','장병국','2014-06-23',3,0,'byungkuk.jang@yescnc.co.kr','책임','010-9900-9889'),
  ('140605','이민호','7100','이민호','2014-06-23',3,0,'mhlee06132@yescnc.co.kr','선임','010-3769-1495'),
  ('140606','박상희','7100','박상희','2014-06-25',3,0,'novles@yescnc.co.kr','선임','010-9339-6229'),
  ('140704','전찬우','7300','전찬우','2014-07-21',3,0,'chanwoo@yescnc.co.kr','연구원','010-6385-9114'),
  ('140801','채영권','7300','채영권','2014-08-01',3,0,'yk0801@yescnc.co.kr','선임','010-3471-4978'),
  ('140901','김동한','7100','김동한','2014-09-11',3,0,'dhkim@yescnc.co.kr','선임','010-9097-4536'),
  ('141001','이창호','7100','이창호','2014-10-13',3,0,'lch0622@yescnc.co.kr','연구원','010-4106-9357'),
  ('1501001','신현규','5100','신현규','2015-01-01',3,0,'shinhk@yescnc.co.kr','책임','010-9588-4396'),
  ('150102','장석규','5100','장석규','2015-01-01',3,0,'sgjang@yescnc.co.kr','책임','010-2822-3422'),
  ('150103','한보선','5100','한보선','2015-01-01',3,0,'hanbs@yescnc.co.kr','책임','010-2951-3801'),
  ('150104','구선모','7300','구선모','2015-01-01',3,0,'smgu@yescnc.co.kr','선임','010-3205-7599'),
  ('150105','노난형','7100','노난형','2015-01-01',3,0,'ting0222@yescnc.co.kr','연구원','010-4940-8556'),
  ('150106','이진호','7100','이진호','2015-01-01',3,0,'jinho.lee@yescnc.co.kr','책임','010-8838-2275');
