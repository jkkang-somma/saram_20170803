...
], function($, _, Backbone, Util, Moment, ComboBox, Dialog, Doc, Form, RowButtonHTML , BookDocumentCollection , BookDocumentModel) {
	var _view;
	var BookView = Backbone.View.extend({
		...
		afterRender: function(){
			this.el.find("#btnDownload").click(function(){
				...
				var url ="/bookdocument/?file=" + data.filename;
		...
		render : function(el) {   		
			...
			bookdocumentCollection = new BookDocumentCollection();
			
			$.when(bookdocumentCollection.fetch()).done(function(){
