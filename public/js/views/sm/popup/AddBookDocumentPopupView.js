define([ 
	...
	var AddBookDocumentPopupView = Backbone.View.extend({
		initialize : function() {
		...
		render : function(el) {
    	    ...
    	    var _view = this;
            $(this.el).append("<input type='file' id='AddBookDocumentFile' multiple style='display:none' accept='.*'></input>");
            ...
            $(this.el).find('#AddBookDocumentFile').fileupload({
                url : '/bookdocument',
//                dataType: '',
                add: function(e, data){
	...
	return AddBookDocumentPopupView;
});